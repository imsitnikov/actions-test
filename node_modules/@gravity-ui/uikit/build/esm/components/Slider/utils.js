...
export function getMarksFromInfoPoints({ infoPointsCount, max, min, }) {
    const marks = {
 ...
 */
export function prepareSliderInnerState({ max = 100, min = 0, availableValues, defaultValue, marksCount, step, value, }) {
    const state = {
        value,
        defaultValue,
        range: false,
