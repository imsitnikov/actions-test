...
export interface TextProps<C extends React.ElementType = 'span'> extends Omit<TextBaseProps, 'ellipsisLines'>, ColorTextBaseProps, QAProps {
    /**
 ...
 * ```
 */
export declare const Text: (<C extends React.ElementType<any, keyof React.JSX.IntrinsicElements> = "span">({ ref, ...props }: TextProps<C> & Omit<React.PropsWithoutRef<React.ComponentProps<C>>, keyof TextProps<T>> & {
