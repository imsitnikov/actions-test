...
export type InitialListParsedState = Pick<ListState, 'disabledById' | 'expandedById' | 'selectedById'>;
export type ParsedFlattenState = {
    visibleFlattenIds: ListItemId[];
    idToFlattenIndex: Record<ListItemId, number>;
};
export type ListParsedState<T> = ParsedState<T> & ParsedFlattenState & {
