...
export const TreeList = ({ qa, id, size = 'm', items, className, expandedById: propsExpandedById, disabledById: propsDisabledById, selectedById: propsSelectedById, activeItemId, defaultGroupsExpanded = true, getItemId, renderItem: propsRenderItem, renderContainer = TreeListContainer, onItemClick, multiple, setActiveItemId, containerRef: propsContainerRef, mapItemDataToProps, }) => {
    ...
    useListKeydown(Object.assign(Object.assign({ containerRef, onItemClick: handleItemClick }, listParsedState), { activeItemId,
        disabledById,
        setActiveItemId }));
    const renderItem = (itemId, index, renderContainerProps) => {
        const renderState = getItemRenderState(Object.assign(Object.assign({ qa, id: itemId, size,
            multiple,
