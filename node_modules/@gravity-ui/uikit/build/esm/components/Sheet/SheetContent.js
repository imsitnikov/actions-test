...
class SheetContent extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { ref: this.veilRef, className: sheetBlock('veil', veilTransitionMod), onClick: isAnimating ? undefined : this.onVeilClick, onTransitionEnd: this.onVeilTransitionEnd, role: "presentation" }),
            React.createElement("div", { ref: this.sheetRef, className: sheetBlock('sheet', sheetTransitionMod), role: "dialog", "aria-modal": "true", "aria-label": title },
