...
function Modal({ open = false, keepMounted = false, disableBodyScrollLock = false, disableEscapeKeyDown, disableOutsideClick, disableFocusTrap, disableAutoFocus, focusTrap = true, autoFocus = true, restoreFocusRef, onEscapeKeyDown, onEnterKeyDown, onOutsideClick, onClose, onTransitionEnter, onTransitionEntered, onTransitionExit, onTransitionExited, children, style, contentOverflow = 'visible', className, contentClassName, 'aria-labelledby': ariaLabelledBy, 'aria-label': ariaLabel, container, qa, }) {
    ...
    return (react_1.default.createElement(react_transition_group_1.CSSTransition, { nodeRef: containerRef, in: open, addEndListener: (done) => { var _a; return (_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.addEventListener('animationend', done); }, classNames: (0, transition_1.getCSSTransitionClassNames)(b), mountOnEnter: !keepMounted, unmountOnExit: !keepMounted, appear: true, onEnter: () => {
        ...
        react_1.default.createElement(Portal_1.Portal, { container: container },
            react_1.default.createElement("div", { ref: containerRef, style: style, className: b({ open }, className), "data-qa": qa },
                react_1.default.createElement("div", { className: b('content-aligner') },
                    react_1.default.createElement("div", { className: b('content-wrapper') },
                        react_1.default.createElement(FocusTrap_1.FocusTrap, { enabled: !disableFocusTrap && focusTrap && open && !inTransition, autoFocus: !disableAutoFocus && autoFocus },
                            react_1.default.createElement("div", Object.assign({ ref: contentRef, tabIndex: -1, role: "dialog", "aria-modal": open, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, className: b('content', { 'has-scroll': contentOverflow === 'auto' }, contentClassName) }, containerProps), children))))))));
}
exports.Modal = Modal;
