...
import type { ListItemCommonProps, ListItemId, ListItemSize, ListItemType, ListParsedState, ListState, RenderItemContext, RenderItemProps } from '../useList';
...
export type TreeListRenderContainerProps<T> = ListParsedState<T> & QAProps & Partial<ListState> & {
    id: string;
    size: ListItemSize;
     ...
     */
    renderContainerProps?: Object): React.JSX.Element;
};
export type TreeListRenderContainer<T> = (props: TreeListRenderContainerProps<T>) => React.JSX.Element;
