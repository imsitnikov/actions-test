...
exports.SelectFilter = react_1.default.forwardRef((props, ref) => {
    ...
    return renderFilter ? (renderFilter({ onChange, onKeyDown, value, ref: inputRef, style })) : (react_1.default.createElement("div", { className: b(), style: style },
        react_1.default.createElement(controls_1.TextInput, { controlRef: inputRef, controlProps: { className: b('input'), size: 1 }, size: size, value: value, placeholder: placeholder, onUpdate: onChange, onKeyDown: onKeyDown, qa: constants_1.SelectQa.FILTER_INPUT })));
});
