...
const ClearButton = (props) => {
    ...
    return (react_1.default.createElement(Button_1.Button, { size: size, className: b(null, className), onClick: onClick, extraProps: {
            onMouseDown: preventDefaultHandler,
            'aria-label': (0, i18n_1.default)('label_clear-button'),
        } },
