...
const COMMON_AVATAR_PROPS = {
    size: 's',
};
const b = (0, cn_1.block)('user-label');
exports.UserLabel = react_1.default.forwardRef(({ type = 'person', avatar, children, view = 'outlined', onClick, onCloseClick, className, style, qa, }, ref) => {
    ...
    switch (type) {
        case 'email':
            avatarView = (react_1.default.createElement(Avatar_1.Avatar, Object.assign({ icon: icons_1.Envelope }, (avatarProps || {}), COMMON_AVATAR_PROPS)));
            break;
        case 'empty':
            avatarView = null;
            break;
        ...
        default:
            if (react_1.default.isValidElement(avatar)) {
                ...
                avatarView = react_1.default.createElement(Avatar_1.Avatar, Object.assign({}, avatarProps, COMMON_AVATAR_PROPS));
            }
            break;
    }
