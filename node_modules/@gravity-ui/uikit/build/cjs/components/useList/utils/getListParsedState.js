...
exports.getListParsedState = void 0;
const getListItemId_1 = require("./getListItemId");
const groupItemId_1 = require("./groupItemId");
const isTreeItemGuard_1 = require("./isTreeItemGuard");
function getListParsedState(items, 
/**
