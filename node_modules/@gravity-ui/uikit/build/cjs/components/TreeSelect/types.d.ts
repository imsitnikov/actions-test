...
import type { TreeListMapItemDataToProps, TreeListOnItemClick, TreeListRenderContainer, TreeListRenderContainerProps } from '../TreeList/types';
import type { QAProps } from '../types';
import type { ListItemId, ListItemSize, ListItemType, ListState, RenderItemContext, RenderItemProps } from '../useList';
...
export interface TreeSelectProps<T, P extends {} = {}> extends QAProps, Partial<Omit<ListState, 'selectedById'>> {
    value?: ListItemId[];
    defaultOpen?: boolean;
