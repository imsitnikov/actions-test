...
function withTableSorting(TableComponent) {
    ...
    return _a = class extends react_1.default.Component {
                            ...
                            return Object.assign(Object.assign({}, column), { meta: Object.assign(Object.assign({}, column.meta), { _originalName: column.name }), name: () => {
                                    ...
                                    const content = [
                                        ...
                                        react_1.default.createElement("div", { key: "indicator", className: b('sort-indicator') },
                                            react_1.default.createElement(SortIndicator_1.SortIndicator, { order: sortOrder })),
                                    ];
                                    ...
                                    return (react_1.default.createElement("div", { role: "button", tabIndex: 0, className: b('sort', { active: Boolean(sortOrder) }), onClick: onClick, onKeyDown: onKeyDown }, content));
                                } });
                        }
                        else {
                            return column;
            ...
            render() {
                const _b = this.props, { columns } = _b, restTableProps = tslib_1.__rest(_b, ["columns"]);
