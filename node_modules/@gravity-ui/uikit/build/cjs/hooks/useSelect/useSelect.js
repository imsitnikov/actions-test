...
const useSelect = ({ defaultOpen, onClose, onOpenChange, open, value: valueProps, defaultValue = [], multiple, onUpdate, }) => {
    const [value, setValue] = (0, useControlledState_1.useControlledState)(valueProps, defaultValue, onUpdate);
