...
export const NotificationsEmptyState = React.memo(function NotificationsEmptyState(props) {
    return (React.createElement("div", { className: b('empty') },
        props.image ? props.image : React.createElement(Icon, { data: nothingFoundSvg, size: 172 }),
        React.createElement("div", { className: b('empty-message') },
            React.createElement("div", { className: b('empty-title') }, props.title || i18n('no-notifications')),
