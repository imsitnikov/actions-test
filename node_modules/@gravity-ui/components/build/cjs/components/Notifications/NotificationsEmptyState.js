...
exports.NotificationsEmptyState = void 0;
...
exports.NotificationsEmptyState = react_1.default.memo(function NotificationsEmptyState(props) {
    return (react_1.default.createElement("div", { className: b('empty') },
        props.image ? props.image : react_1.default.createElement(uikit_1.Icon, { data: nothingFoundSvg, size: 172 }),
        react_1.default.createElement("div", { className: b('empty-message') },
            react_1.default.createElement("div", { className: b('empty-title') }, props.title || (0, index_1.i18n)('no-notifications')),
